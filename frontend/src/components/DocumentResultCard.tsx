  ...
  return (
    <div className={`card animate-fade-in ${
      ...
      {(documentData.mrz_verified !== null || documentData.barcode_verified !== null) && (
        <div className="mb-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl border-2 border-gray-200 dark:border-gray-600">
